          ...
          {viewReport && (
            <div className="space-y-4 mt-2">
              ...
              <div className="bg-slate-50 p-3 rounded-lg">
                ...
                <ViewFieldRow label="9. Condition of brakes at the time of inspection" value="" />
              ...
              <div className="bg-slate-50 p-3 rounded-lg">
                ...
                <ViewFieldRow label="Inspector Name" value={viewReport.inspectorName} />
                <ViewFieldRow label="Inspector Title" value={viewReport.inspectorTitle} />
                <ViewFieldRow label="Inspector Location" value={viewReport.inspectorLocation} />
              </div>
